...
#ifndef TTTowInputFilter_hpp
#define TTTowInputFilter_hpp
...
/**
支持两个纹理输入的处理类，绑定已经上传的 rgb 纹理，
纹理1 绑定 GL_TEXTURE2 ，纹理 2 绑定 GL_TEXTURE3
进行处理，并输出到纹理 GL_TEXTURE1
*/
class TowInputFilter : public Filter {
public:
    TowInputFilter();
    ~TowInputFilter();
...
private:
    TT_SP(Framebuffer) _inputFramebuffer2 = nullptr;
